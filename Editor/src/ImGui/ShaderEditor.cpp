...
namespace Simulatrix {
    ...
    ShaderEditor::ShaderEditor(Ref<Scene> scene, Ref<IconLibrary> iconLibrary) : m_Scene(scene), m_IconLibrary(iconLibrary) {
    ...
    void ShaderEditor::SetScene(const Ref<Scene>& scene) {
        m_Scene = scene;
    }
}